...
namespace BoletoNet
{
    ...
    public class BoletoBancario : System.Web.UI.Control
    {
        ...
        private string MontaHtml(string urlImagemLogo, string urlImagemBarra, string imagemCodigoBarras)
        {
            ...
            {
                StringBuilder demonstrativo = new StringBuilder();
                html.Append(Html.ReciboCedenteRelatorioValores);
                html.Append(Html.ReciboCedenteParte5);
                //
                demonstrativo.Append(Html.CabecalhoTabelaDemonstrativo);
                var textoReplace = "<table class=\"w666\">";
                var cabecalho =  demonstrativo.ToString().Substring(textoReplace.ToString().IndexOf(textoReplace));
                cabecalho = "<table class=\"w666\" style=\"min-height: 400px; max-height: 400px;\"><tr style=\"max-height: 12px; height: 12px;\" class=\"rBb\">" + cabecalho.Substring(cabecalho.IndexOf("<td"));
               
                html.Append(cabecalho);
                //html = html.Replace("<tr class=\"ct\">", "<tr class=\"ct\" style=\"height: 12px;\" >");
               ...
               string demonstrativoFormatado = grupoDemonstrativo.ToString().Replace("<tr class=\"ct\">", "<tr class=\"ct\" style=\"max-height: 12px; height: 12px;\">");
                //for (int i = contador; i < 10; i++)
                //{
                //    demonstrativoFormatado = demonstrativoFormatado.Replace("<tr class=\"ct\" style=\"max-height: 12px; height: 12px;\">", "<tr class=\"ct\" style=\"max-height: 12px; height: 12px;\">" + "<tr class=\"ct\" style=\"max-height: 12px; height: 12px;\"></tr>");
                //}

                html = html.Replace("@ITENSDEMONSTRATIVO", demonstrativoFormatado);
            }
