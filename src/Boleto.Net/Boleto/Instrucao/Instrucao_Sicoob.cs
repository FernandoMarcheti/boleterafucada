namespace BoletoNet
{
    ...
    public class Instrucao_Sicoob : AbstractInstrucao, IInstrucao
	{
        ...
        public Instrucao_Sicoob(int codigo, decimal valorMulta)
        {
            this.carregar(codigo, 0, (double)valorMulta);
        }
            ...
            try
            {
                ...
                switch ((EnumInstrucoes_Sicoob)idInstrucao)
                {
                    ...
                    case EnumInstrucoes_Sicoob.CobrarJuros:
                        ...
                        this.Descricao = "Após o Vencimento Cobrar Juros de " + Math.Round(percentualMultaDia * 100, 2).ToString().Replace(".", ",") + " % ao dia";
                        break;
                    ...
                    case EnumInstrucoes_Sicoob.DevolverApos30DiasVencido:
                        ...
                        break;
                    case EnumInstrucoes_Sicoob.ValorMulta:
                        this.Codigo = (int)EnumInstrucoes_Sicoob.ValorMulta;
                        this.Descricao = "E Multa de R$ " + string.Format("{0:0.00}", percentualMultaDia);
                        break;
                    default:
                        this.Codigo = 0;
