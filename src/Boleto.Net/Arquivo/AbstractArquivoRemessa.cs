...
namespace BoletoNet
{
    ...
    public abstract class AbstractArquivoRemessa: IArquivoRemessa
    {
        ...
        public virtual void GerarArquivoRemessa(string numeroConvenio, IBanco banco, Cedente cedente, Boletos boletos, Stream arquivo, int numeroArquivoRemessa, string obs = "")
        {
            this.Banco = banco;
            this.Cedente = cedente;
            this.Boletos = boletos;
            this.NumeroConvenio = numeroConvenio;
            this.NumeroArquivoRemessa = numeroArquivoRemessa;
            _arquivoRemessa.GerarArquivoRemessa(numeroConvenio, banco, cedente, boletos, arquivo, numeroArquivoRemessa, obs);
        }
