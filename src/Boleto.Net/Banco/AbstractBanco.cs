...
namespace BoletoNet
{
    public abstract class AbstractBanco
    {
        ...
        /// Gera registros de detalhe do arquivo remessa - SEGMENTO P
        /// </summary>
        public virtual string GerarDetalheSegmentoPRemessa(Boleto boleto, int numeroRegistro, string numeroConvenio, int contadorLoteServico)
        {
            string _segmentoP = "";
            return _segmentoP;
        }
        ...
        /// Gera registros de detalhe do arquivo remessa - SEGMENTO Q
        /// </summary>
        public virtual string GerarDetalheSegmentoQRemessa(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo, int contadorLoteServico)
        {
            string _segmentoQ = "";
            return _segmentoQ;
        }
        ...
        /// </summary>
        public virtual string GerarDetalheSegmentoRRemessa(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo, int contadorLoteServico)
        {
            string _segmentoR = "";
            return _segmentoR;
        }
